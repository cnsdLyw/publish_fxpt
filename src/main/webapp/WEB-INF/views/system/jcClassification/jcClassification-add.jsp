...
<body class="no-skin">
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="col-xs-12" class="form-horizontal">
				   <div class="row">
					<div class="col-xs-12">
						<form id="mainForm" class="form-horizontal" method="POST" action="${ctx}/jcClassification/saveClass" commandName="jcClassification">
							<input type="hidden" id="classKey" name="classKey" value="${jcClassification.classKey }" />
							<input type="hidden" id="parentCode" name="parentCode" value="${jcClassification.parentCode }" />
							...
							<div class="form-group">
								...
								<div class="col-xs-10 col-md-10 col-sm-10 col-lg-10">
									<input type="text" class="col-xs-8 col-md-8 col-sm-8 col-lg-8" id="className" name="className" value="${jcClassification.className}" placeholder="请输入分类名称"
							...
							<div class="form-group">
								...
								<div class="col-xs-10 col-md-10 col-sm-10 col-lg-10">
									<c:if test="${jcClassification.classCode!=null }">
										<input type="text" class="col-xs-8 col-md-8 col-sm-8 col-lg-8" id="classCode" name="classCode" value="${jcClassification.classCode}" readonly="readonly">
									</c:if>
									<c:if test="${jcClassification.classCode==null }">
										<input type="text" class="col-xs-8 col-md-8 col-sm-8 col-lg-8" id="classCode" name="classCode" value="${jcClassification.classCode}" 
							...
							<div class="form-group">
								...
								<div class="col-xs-10 col-md-10 col-sm-10 col-lg-10">
									   <textarea class="col-xs-8 col-md-8 col-sm-8 col-lg-8" type="text" rows="3" id="remark" name="remark"
										data-rule-maxlength='50' placeholder="请输入备注">${jcClassification.remark}</textarea>
								</div>
							</div>
	...
	function extendsValidate() {
		 ...
		 $.ajax({
		      type : "get",  
		      url : "${ctx}/jcClassification/isClassCodeExist",  
		      dataType:"json",  
	...
	<c:if test="${param.message==1 }">
		window.parent.setTreeDate("${jcClassification.classKey}","${jcClassification.classCode}");
	</c:if>
